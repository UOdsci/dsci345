...
- provide a grade-based motivation to keep up with the readings;
- give you feedback on your ability to do modelling without assistance;
- help the instructor understand the state of knowledge in the class.
